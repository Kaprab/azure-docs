...
The above section states 'Any charges incurred up to the point of migration are invoiced to the EA and must be settled on that enrollment.'
However we have a case where customer expected that all the usage from the EA enrollment on June 30th should have been accrued to the EA, the transition to the MCA only happened at about 4.45pm pst and the billing on the MCA should only happen after this time. The MCA had discounts effective from July 1.
Engineering responded 'The transition from EA to MCA happened at 4:45pm. Usage will be calculated under the MCA from the 00th hour of 30th June. Any usage under the EA on June 30th before transition will be removed from EA and moved to MCA, This is by design.' Due to this, all the usage for June 30 was moved to MCA and no disciunt was applied. Ref ICM 834510483
